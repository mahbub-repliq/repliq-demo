        ...
        <form onSubmit={formik.handleSubmit}>
          <div className="md:flex gap-3 py-2">
            <div>
              ...
              />
              {formik.errors.firstName && <p className="text-xs pt-2 text-secondary"> First name is required.</p> }
            </div>
            <div>
              ...
              />
              {formik.errors.lastName && <p className="text-xs pt-2 text-secondary"> First name is required.</p> }
            </div>
          </div>
          <div className="py-2">
            <label htmlFor="">Email</label>
            <input
              className={`block border rounded w-full p-2 focus:outline-none ${formik.errors.email ? 'border-secondary' : ''}`}
              id="email"
              name="email"
              type="email"
              onChange={formik.handleChange}
            ...
            />
            {formik.errors.email && <p className="text-xs pt-2 text-secondary"> First name is required.</p> }
          </div>
          <div className="py-2 relative">
            <label htmlFor="">Password</label>
            <input
              className={`block border rounded w-full p-2 focus:outline-none ${formik.errors.password ? 'border-secondary' : ''}`}
            ...
            />
            {formik.errors.password && <p className="text-xs pt-2 text-secondary"> {formik.errors.password} </p> }
            <div

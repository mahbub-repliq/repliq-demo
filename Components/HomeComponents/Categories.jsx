...
function Category() {
  return (
    <div className="py-4 md:py-8 lg:py-12 px-4 md:px-8 lg:px-12 bg-[#FFFFFF]">
      <div className="basis-1/3 flex justify-between mb-5">
      ...
      <div className="basis-2/3 grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-5 mt-8 md:mt-0">
        <div className={`text-slate-800 rounded bg-accent py-3 md:py-5`}>
        ...
        <div className={`text-slate-800 rounded bg-accent py-3 md:py-5 hidden md:block`}>
          <div className="flex justify-center items-center mb-3">
            {" "}
